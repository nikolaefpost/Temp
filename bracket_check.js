...
//  if (k>0) nuberArea0.innerHTML='В строке: "' + newString +'" не хватает ' + k + ' закрывающихся скобок.';
//  if (k<0) nuberArea0.innerHTML='В строке: "' + newString +'" не хватает ' + k + ' открывающихся скобок.';
//  else nuberArea0.innerHTML='Строка: "' + newString +'" прошла проверку.';
